...
OWNER_ID = "5268655042"
bot = telebot.TeleBot('7889321312:AAGEMBL5yuCiJkKVymwS_4ft2jseNfEbzFY')
...
def load_user_access():
    try:
        with open(USER_ACCESS_FILE, "r") as file:
            ...
            for line in file:
                parts = line.strip().split(",")
                if len(parts) >= 3:  # Handle backup format
...
🛡️ For assistance, contact <a href="tg://user?id=5268655042">@Junaidx_16</a>
